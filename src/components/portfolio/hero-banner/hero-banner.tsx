...
const HeroBanner: React.FC = () => {
  ...
  return (
    ...
    >
      <Layout
        style={screen === "smaller" ? styles.mainDivMobile : styles.mainDiv}
      >
        <Row gutter={[16, 16]}>
          {" "}
          <Col
          ...
          >
            ...
            >
              Passionate problem-solver and innovative thinker with a keen eye
              for detail. Highly motivated and adaptable, I approach challenges
              with enthusiasm, striving for exceptional results. As an AI
              enthusiast and blogger, I am dedicated to continuous learning and
              expanding my expertise in creative solutions
            </Paragraph>
          </Col>
          <Col
